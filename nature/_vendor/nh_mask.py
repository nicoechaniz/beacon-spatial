"""Vendored harmonic_mask from digital-beacon packages/nh-analysis.

Original path:
  packages/nh-analysis/src/nh_analysis/mask.py :: harmonic_mask

Self-contained: depends only on numpy + librosa (no other nh_analysis modules).
"""
