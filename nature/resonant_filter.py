...
Reuses nature._vendor.nh_mask.harmonic_mask (vendored from nh_analysis.mask)
and adapts the mask bandwidth based on sample descriptors (flatness,
inharmonicity, stability). The filter separates a sample into harmonic (on the
f1 lattice) and residual components, and provides harmonicity descriptors that
can drive beacon mappings.
"""
